...
class Record:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            "params": (
                self.params._to_dict()
                if hasattr(self.params, "_to_dict")
                else dataclasses.asdict(self.params)
            ),
            "result": (
                self.result._to_dict()
                if hasattr(self.result, "_to_dict")
                else (
                    dataclasses.asdict(self.result) if self.result is not None else None
                )
            ),
        }
    ...
    def from_dict(cls, dct: Mapping) -> "Record":
        ...
        r = (
            ...
            else cls.result_cls(**dct["result"]) if cls.result_cls is not None else None
        )
...
class Recorder:
    ...
    def register_record_type(cls, rec_type) -> Any:
        ...
        cls._record_name_by_params_name[rec_type.params_cls.__name__] = (
            rec_type.__name__
        )
        return rec_type
